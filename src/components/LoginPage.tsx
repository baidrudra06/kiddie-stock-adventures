...
const LoginPage = () => {
  ...
  const handleEmailLogin = (e: React.FormEvent) => {
    ...
    // Simulate login - in a real app, this would connect to an auth service
    setTimeout(() => {
      // For demo purposes, accept any email/password
      if (email && password) {
        // Login successful
        localStorage.setItem('ksa-user', JSON.stringify({
          id: '123',
          email: email,
          name: email.split('@')[0],
        ...
        toast({
          ...
          description: "Welcome to Kiddie Stock Adventures!",
        });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 to-blue-100 px-4">
      <Card className="max-w-md w-full">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl">Welcome to Kiddie Stock Adventures!</CardTitle>
          <CardDescription>
            Log in to track your progress and manage your virtual portfolio
          </CardDescription>
        </CardHeader>
